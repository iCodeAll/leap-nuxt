    ...
    <div class="container">
      ...
      <div class="row mb-5">
        ...
        <div class="col-lg-5 col-xl-4 mt-3 mt-lg-0">
          <h5>Subscribe</h5>
          <p>
            The latest Leap news, articles, and resources, sent straight to your
            inbox every month.
          </p>
                ...
                >
                  ...
                  >
                    <div class="grecaptcha-logo">
                      <iframe
                        src="https://www.google.com/recaptcha/api2/anchor?ar=1&amp;k=INSERT_YOUR_RECAPTCHA_V2_SITEKEY_HERE&amp;co=aHR0cDovL2xvY2FsaG9zdDozMDAw&amp;hl=en&amp;v=Y5tQ3lKwn1XL5hGgLz1kR4-1&amp;size=invisible&amp;badge=bottomleft&amp;cb=tiogueecrxht"
                        width="256"
                        height="60"
                        role="presentation"
                        name="a-jriers2v5oxk"
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  class="injected-svg icon"
                  data-src="assets/img/icons/social/youtube.svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                >
            ...
            <li class="nav-item">
              <a href="#" class="nav-link">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  class="injected-svg icon"
                  data-src="assets/img/icons/social/medium.svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                >
      ...
      <div class="row justify-content-center">
        <div class="col col-md-auto text-center">
          <small class="text-muted"
            >©2020 This page is protected by reCAPTCHA and is subject to the
            Google
